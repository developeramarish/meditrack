...
export function HowItWorksSection() {
  return (
    <section id="how-it-works" className="bg-muted py-10 md:py-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative mt-16 hidden items-start justify-between md:flex">
          <div className="absolute left-[10%] right-[10%] top-[44px] border-t-2 border-dashed border-border" />
          {steps.map((step, stepIndex) => (
            <div key={step.label} className="relative z-10 flex w-1/4 flex-col items-center text-center">
              <div className="mb-3 rounded-xl bg-card p-2.5 shadow-sm">
              ...
              <p className="mt-1 max-w-[180px] text-xs leading-relaxed text-muted-foreground">{step.description}</p>
            </div>
          ))}
        </div>
        ...
        <div className="relative mt-10 pl-10 md:hidden">
          <div className="absolute bottom-4 left-[14px] top-4 border-l-2 border-dashed border-border" />
